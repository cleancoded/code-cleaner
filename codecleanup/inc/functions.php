...
/***********************************************************************/
function codecleanup_edd_activate_license() {

	//listen for our activate button to be clicked
	if(isset($_POST['codecleanup_edd_license_activate'])) {

		//run a quick security check
	 	if(!check_admin_referer('codecleanup_edd_nonce', 'codecleanup_edd_nonce')) {
		...
		update_option('codecleanup_edd_license_status', $license_data->license);
	}
}
add_action('admin_init', 'codecleanup_edd_activate_license');

function codecleanup_edd_deactivate_license() {
...
add_action('admin_init', 'codecleanup_edd_deactivate_license');

function codecleanup_edd_check_license() {
	...
	if($license_data->license == 'valid') {
		update_option('codecleanup_edd_license_status', "valid");
	}
	else {
		update_option('codecleanup_edd_license_status', "invalid");
	}
